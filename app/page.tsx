...
export default function SvgFollowPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-white p-8">
      ...
      >
        <image href="img.png" x="0" y="-30" width="210" height="297" />
        {/* Define the path */}
        <path
          id="motionPath"
          d="m 147.25129,29.48868
        ...
        <g>
          <g>
            <image href="/0Z.png" width="5" height="5" x="0" y="0" />
          </g>
          <animateTransform
          ...
          />
          <animateMotion repeatCount="indefinite" dur="5s" begin="0s">
        ...
        <g>
          <g>
            <image href="/0Z.png" width="5" height="5" x="-1" y="-3" />
            <image href="/0Z.png" width="5" height="5" x="2" y="2" />
            <image href="/0Z.png" width="5" height="5" x="-4" y="4" />
          </g>
          <animateTransform
            attributeName="transform"
            type="scale"
            ...
            repeatCount="indefinite"
          />
          <animateMotion repeatCount="indefinite" dur="6s" begin="0s">
        ...
        <g>
          <g>
            <image href="/0Z.png" width="5" height="5" x="5" y="-5" />
            <image href="/0Z.png" width="5" height="5" x="-3" y="0" />
            <image href="/0Z.png" width="5" height="5" x="0" y="-4" />
            <image href="/0Z.png" width="5" height="5" x="3" y="2" />
            <image href="/0Z.png" width="5" height="5" x="-5" y="1" />
            <image href="/0Z.png" width="5" height="5" x="0" y="0" />
            <image href="/0Z.png" width="5" height="5" x="2" y="-2" />
          </g>
          <animateTransform
            ...
            repeatCount="indefinite"
          />
          <animateMotion repeatCount="indefinite" dur="8s" begin="0s">
        ...
        <g>
          <g>
            <image href="/0Z.png" width="5" height="5" x="2" y="-5" />
            <image href="/0Z.png" width="5" height="5" x="-1" y="5" />
            <image href="/0Z.png" width="5" height="5" x="3" y="1" />
          </g>
          <animateTransform
            attributeName="transform"
            type="scale"
            ...
            repeatCount="indefinite"
          />
          <animateMotion repeatCount="indefinite" dur="9s" begin="0s">
        ...
        <g>
          <g>
            <image href="/0Z.png" width="5" height="5" x="4" y="3" />
            <image href="/0Z.png" width="5" height="5" x="-2" y="-1" />
            <image href="/0Z.png" width="5" height="5" x="0" y="-4" />
          </g>
          <animateTransform
            attributeName="transform"
            ...
            repeatCount="indefinite"
          />
          <animateMotion repeatCount="indefinite" dur="10s" begin="0s">
