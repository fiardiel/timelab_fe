...
<main className="flex min-h-screen items-center justify-center bg-white p-8 relative overflow-hidden">
      ...
      >
        ...
        {renderAnimatedImage(point1, 1, 5)}
        {renderAnimatedImage(point2, 2, 6)}
        {renderAnimatedImage(point3, 3, 8)}
        {renderAnimatedImage(point4, 4, 9)}
        {renderAnimatedImage(point5, 5, 10)}
      </svg>
